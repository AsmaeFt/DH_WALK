...
const Tabledata = ({ data, selectedProject, family, handleChange }) => {
          ...
          <tr>
            ...
            {data
              ...
              .map((week) => {
                ...
                if (project) {
                  return (
                    <td key={week._id}>{project.project_OS.Digitalization}</td>
                  );
                }
              })}
          </tr>
          ...
          <tr>
            ...
            {data
              ...
              .map((week) => {
                ...
                if (project) {
                  return (
                    <td key={week._id}>{project.project_actual_DH.Transfer}</td>
                  );
                }
              })}
          </tr>
